...
import CartCheckoutNow from "../../components/checkout/CartCheckoutNow";
...
const CheckoutNow = () => {
  const { bookId } = useParams<{ id: string }>(); // Get the id parameter from the URL
  const { token } = useAuth();
